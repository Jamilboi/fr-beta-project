...
static const struct SpriteFrameImage sPicTable_BrendanSurfing[] = {
    ...
    overworld_frame(gObjectEventPic_BrendanSurfing, 2, 4, 9),
    overworld_frame(gObjectEventPic_BrendanSurfing, 2, 4, 10),
    overworld_frame(gObjectEventPic_BrendanSurfing, 2, 4, 11),
    overworld_frame(gObjectEventPic_BrendanSurfing, 2, 4, 12),
    overworld_frame(gObjectEventPic_BrendanSurfing, 2, 4, 13),
};
