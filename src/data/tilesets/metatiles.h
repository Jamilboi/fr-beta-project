...
const u16 gMetatiles_KantoPrimary[] = INCBIN_U16("data/tilesets/primary/kanto_primary/metatiles.bin");
const u16 gMetatileAttributes_KantoPrimary[] = INCBIN_U16("data/tilesets/primary/kanto_primary/metatile_attributes.bin");
