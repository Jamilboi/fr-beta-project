...
const struct Tileset gTileset_KantoPrimary =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_KantoPrimary,
    .palettes = gTilesetPalettes_KantoPrimary,
    .metatiles = gMetatiles_KantoPrimary,
    .metatileAttributes = gMetatileAttributes_KantoPrimary,
    .callback = NULL,
};
